...
func main() {
	...
	if !multipleTableDb {
		...
		for i := 1; i <= recordCount; i++ {
			row := []string{util.RandomString(5), util.RandomString(10), util.RandomString(10), util.RandomString(50), util.RandomDate(),
				strconv.FormatBool(util.RandomBool()), strconv.FormatFloat(util.RandomFloat(150, 200), 'E', -1, 64), strconv.Itoa(int(util.RandomInt(1000, 100000))), util.CurrentTimestamp()}

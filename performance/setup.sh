...
if type mysql >/dev/null 2>&1; then
    ...
    for insertRecordCount in 100 200 300
    do
        ...
        do
            ...
            --description="My Instance" --nodes=$nodes
            ...
            do
                ...
                go run main.go schema-and-data -source=mysql -source-profile='host=localhost,user=root,db_name=testdb,password=' -target-profile='instance=hb-spangres-testing,dbname=testdb' -write-limit $writeLimit
            done
